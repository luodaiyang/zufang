...
public class AddressServiceImpl implements  IAddressService {
    ...
    private  static final  String BAIDU_MAP_KEY="TvP1V1vT89Ahs6COtcMrZcj6geOgG3Pz";
    //百度位置转码服务APL
    ...
    public ServiceResult lbsUpload(BaiduMapLocation location, String title,
        ...
        nvps.add(new BasicNameValuePair("geotable_id", "201962"));
    ...
    private boolean isLbsDataExists(Long houseId) {
        ...
        sb.append("geotable_id=").append("201962").append("&")
